...
const AddFbpage = () => {
  ...
  const { loading, data, error, postData } = usePost('/api/fbpages/add');
  ...
  const handleSubmit = (e) => {
    ...
    if (!imgRef.current.value.trim().startsWith('http')) return alert('Thumbnail input should be a link.');
